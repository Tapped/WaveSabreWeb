#ifndef __WAVESABRECORE_MULTIFORM_H__
#define __WAVESABRECORE_MULTIFORM_H__
...
{
	class Multiform : public SynthDevice
	{
	public:
	...
	private:
		class MultiformVoice : public Voice
		{
		public:
			MultiformVoice(Multiform *device);
